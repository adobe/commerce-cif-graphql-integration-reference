...
class ProductsLoader {
    ...
    __searchProducts(params, actionParameters) {
        ...
        if (params.search || params.categoryId || (params.filter && (params.filter.category_id || params.filter.category_uid || params.filter.price))) { // Text search or fetching of the products of a category
